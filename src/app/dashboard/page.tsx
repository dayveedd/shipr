...
import { Trophy, Flame, ShieldCheck, ArrowRight, Clock, CheckCircle2, AlertCircle, Loader2 } from "lucide-react";
...
export default function DashboardPage() {
  ...
  // Mock Active Submissions with Asynchronous Stages
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <RankBadge rank={user?.rank || "GOLD"} />
            </div>
            <p className="text-xs font-mono text-zinc-500">
              @{user?.githubUsername || "alexdev"} • Joined {user?.joinedAt ? new Date(user.joinedAt).toLocaleDateString() : "Jan 2026"}
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <StatCard
          ...
          value={formatNGN(user?.totalEarnedNgn || 87500)}
